...
const Victory = () => {
    ...
    return (
        <div className='p-5'>
            <div className="">
                <h2 className="sm:mb-5 my-3 text-xl font-extrabold">
                            ...
                            >
                                <div className="p-3 py-2 flex flex-col lg:flex-row justify-between lg:items-center ">
                                    ...
                                    <Link
                                        ...
                                        className="px-3 py-2 text-center font-semibold text-white transition-all duration-300 transform rounded-full bg-gradient-to-r from-yellow-400 to-red-500 hover:from-yellow-500 hover:to-red-600 hover:shadow-md hover:-translate-y-1"
                                    >
                                        View Your Auction
                                    </Link>
                                </div>
